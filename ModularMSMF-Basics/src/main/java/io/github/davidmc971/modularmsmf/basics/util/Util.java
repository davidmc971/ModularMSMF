...
import io.github.davidmc971.modularmsmf.basics.LanguageManager;
...
public class Util {
	...
	public static FileConfiguration configureCommandLanguage(CommandSender sender){
		ModularMSMFBasics plugin = ModularMSMFBasics.Instance();
	 ...
	 * @return 
	 */
	public static void broadcastWithConfiguredLanguageEach(ChatUtil.ChatFormat format, String languageKey, String... toReplace) {
		ModularMSMFBasics plugin = ModularMSMFBasics.Instance();
		String prefix = ChatUtil.getFormattedPrefix(format);
	 ...
	 *  Can be empty.
	 */
	public static void sendMessageWithConfiguredLanguage(CommandSender subject, ChatUtil.ChatFormat format, String languageKey, String... toReplace) {
		ModularMSMFBasics plugin = ModularMSMFBasics.Instance();
		String prefix = ChatUtil.getFormattedPrefix(format);
		FileConfiguration language = configureCommandLanguage(subject);
		String configuredMessage = prefix + language.getString(languageKey);
